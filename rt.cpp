...
CProcess::CProcess(	
		...
		: ProcessName(Name)
{
	// IF VARIABLE DOES NOT EQUAL ANY OF THE BOOLEAN VALUES IN PERR, THEN OUTPUTS ERROR MESSAGE
	...
	// Checks OWN_WINDOW or PARENT_WINDOW are the only two arguments used
